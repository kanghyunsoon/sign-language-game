...
// A 1:1 board only occupies half of the shared stage. At 240px, the playable
// area reaches the finish line after roughly 9-13 settled glyphs depending
...
export const BATTLE_LETTER_SIZE = 240;
