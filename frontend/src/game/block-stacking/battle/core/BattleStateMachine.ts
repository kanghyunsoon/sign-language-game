...
const TRANSITIONS: Readonly<Record<BattlePageState, readonly BattlePageState[]>> = {
  IDLE: ["CONNECTING", "ERROR"], CONNECTING: ["WAITING_START", "COUNTDOWN", "PLAYING", "RECONNECTING", "ERROR", "IDLE"], WAITING_START: ["COUNTDOWN", "PLAYING", "RECONNECTING", "ERROR", "IDLE"],
  COUNTDOWN: ["PLAYING", "RECONNECTING", "FINISHED", "ERROR"], PLAYING: ["RECONNECTING", "FINISHED", "ERROR"],
  RECONNECTING: ["WAITING_START", "COUNTDOWN", "PLAYING", "FINISHED", "ERROR", "IDLE"], FINISHED: ["IDLE", "COUNTDOWN", "PLAYING"], ERROR: ["CONNECTING", "IDLE"],
};
