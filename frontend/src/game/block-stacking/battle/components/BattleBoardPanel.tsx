...
import { BATTLE_DANGER_LINE_RATIO, BATTLE_DANGER_LINE_Y, BATTLE_LETTER_COLOR, BATTLE_LETTER_SHADOW_COLOR, BATTLE_LETTER_SIZE } from "../core/BattleRuntimeConfig";
