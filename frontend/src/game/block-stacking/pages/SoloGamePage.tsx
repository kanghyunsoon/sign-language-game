...
import resultOtter from "../assets/game-menu-otter.webp";
import letterOtter from "../assets/solo-letter-otter.webp";
import startTitle from "../assets/solo-start-title.webp";
import startPodiumOtters from "../assets/solo-start-podium-otters.webp";
import hintCarryFrame0 from "../assets/solo-paper-carry-frame-0.webp";
import hintCarryFrame1 from "../assets/solo-paper-carry-frame-1.webp";
import hintCarryFrame2 from "../assets/solo-paper-carry-frame-2.webp";
import hintCelebrateFrame0 from "../assets/solo-paper-celebrate-frame-0.webp";
import hintCelebrateFrame1 from "../assets/solo-paper-celebrate-frame-1.webp";
import hintCelebrateFrame2 from "../assets/solo-paper-celebrate-frame-2.webp";
import hintCelebrateFrame3 from "../assets/solo-paper-celebrate-frame-3.webp";
import hintPaperThrow from "../assets/solo-paper-throw.webp";
    ...
    >
      ...
      <section className="solo-workspace" aria-label="Solo physics game">
        <div className={`solo-stage-column${snapshot.runState === "GAME_OVER" ? " is-game-over" : ""}`}>
          ...
          <div className="solo-hint-otter-viewport" aria-hidden="true">
